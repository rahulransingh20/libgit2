...
void test_core_stream__register_insecure(void)
{
	...
	ctor_called = 0;
	cl_git_pass(git_stream_register(&registration, 0));
	...
	ctor_called = 0;
	stream = NULL;
	cl_git_pass(git_stream_register(NULL, 0));
	cl_git_pass(git_socket_stream_new(&stream, "localhost", "80"));
...
void test_core_stream__register_tls(void)
{
	...
	ctor_called = 0;
	cl_git_pass(git_stream_register(&registration, 1));
	...
	ctor_called = 0;
	stream = NULL;
	cl_git_pass(git_stream_register(NULL, 1));
