...
typedef enum {
	...
	GIT_INDEX_ENTRY_WT_REMOVE         =  (1 << 6), /**< remove in work directory */
...
#define GIT_IDXENTRY_EXTENDED2         GIT_INDEX_ENTRY_EXTENDED2
#define GIT_IDXENTRY_EXTENDED_FLAGS   (GIT_INDEX_ENTRY_INTENT_TO_ADD | GIT_INDEX_ENTRY_SKIP_WORKTREE)
#define GIT_IDXENTRY_UPDATE            GIT_INDEX_ENTRY_UPDATE
#define GIT_IDXENTRY_REMOVE            GIT_INDEX_ENTRY_REMOVE
#define GIT_IDXENTRY_UPTODATE          GIT_INDEX_ENTRY_UPTODATE
#define GIT_IDXENTRY_ADDED             GIT_INDEX_ENTRY_ADDED
#define GIT_IDXENTRY_HASHED            GIT_INDEX_ENTRY_HASHED
#define GIT_IDXENTRY_UNHASHED          GIT_INDEX_ENTRY_UNHASHED
#define GIT_IDXENTRY_WT_REMOVE         GIT_INDEX_ENTRY_WT_REMOVE
#define GIT_IDXENTRY_CONFLICTED        GIT_INDEX_ENTRY_CONFLICTED
#define GIT_IDXENTRY_UNPACKED          GIT_INDEX_ENTRY_UNPACKED
#define GIT_IDXENTRY_NEW_SKIP_WORKTREE GIT_INDEX_ENTRY_NEW_SKIP_WORKTREE
